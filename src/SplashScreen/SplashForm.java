...
public class SplashForm extends Form
  ...
  public void setAppName(java.lang.String value) {
    try {
      javonetHandle.set("AppName", value);
  ...
  public java.lang.String getAppName() {
    try {
      java.lang.String res = javonetHandle.get("AppName");
      if (res == null) return "";
  ...
  public SplashForm() {
    super((NObject) null);
    try {
      javonetHandle = Javonet.New("SplashScreen.SplashForm");
  ...
  public SplashForm(NObject handle) {
    super(handle);
